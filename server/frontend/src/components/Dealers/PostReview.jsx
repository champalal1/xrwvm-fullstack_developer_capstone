...
const PostReview = () => {
  ...
  let carmakes_url = root_url + `djangoapp/getallcarmakes`;
  ...
  const get_carmakes = async () => {
    ...
    let carmakesarr = Array.from(retobj.CarMakes);
      ...
      <div style={{ margin: "5%" }}>
        ...
        <div className="input_field">
          ...
          >
            ...
            {carmodels
              .filter((carmodel) => carmodel.CarMake === make)
              .map((carmodel) => (
                <option
